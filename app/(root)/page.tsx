    ...
    <div className="space-y-6">
      <section className="grid gap-6 xl:grid-cols-[1fr_420px]">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
            Good to see you, {user?.name?.split(" ")[0] || "there"}. Your market
            workspace is live.
          </p>
        </div>
        ...
        <div className="terminal-panel p-5">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {[
              ...
              <div
                key={name}
                className="rounded-lg border border-gray-700 bg-gray-700/70 p-3"
              >
              ...
              {watchlist.slice(0, 4).map((item, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Star
                      className={`size-4 ${index % 2 ? "text-gray-500" : "fill-yellow-400 text-yellow-400"}`}
                    />
                  </div>
                  ...
                  <p
                    className={
                      index % 3 === 1
                        ? "mt-3 text-xs font-semibold text-red-500"
                        : "mt-3 text-xs font-semibold text-teal-400"
                    }
                  >
                    {index % 3 === 1 ? "-0.24%" : "+2.04%"}
                  </p>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <div className="terminal-panel overflow-hidden">
          <div className="flex items-center justify-between">
            <h2 className="px-5 py-4 text-lg font-semibold text-gray-100">
              Today&apos;s Top Stocks
            </h2>
                ...
                {dashboard.stocks.length === 0 ? (
                  <tr>
                    <td className="px-5 py-8 text-sm text-gray-500" colSpan={7}>
                      Live market data is waiting on Finnhub or temporarily
                      rate-limited.
                    </td>
                  </tr>
                ) : null}
              ...
              >
                <div className="min-w-0">
                  ...
                  <Link
                    href={story.url}
                    target="_blank"
                    className="mt-3 block text-sm font-medium leading-6 text-gray-200 hover:text-yellow-400"
                  >
                    {story.headline}
                  </Link>
                </div>
                ...
                >
                  {index === 1 ? (
                    ...
                    <TrendingDown className="size-5 text-yellow-400" />
                  )}
